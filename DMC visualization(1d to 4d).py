...
For 1d/2d/3d visualization
new varaible generated:
1. ln(area+1): float64
based on the characteristics of variable'area', remodel'area' with logarithm transform
2. FIRE: str
fire/no fire ,indicating whether there's fire
...
'''
Single Parameter/One Dimension
'''
n=1
...
'''
According to the above three plots of 'area', the parameter is pretty distorted towards 0.0
Thus using ln(area+1) to remodel 'area'
'''
...
'''
figure 17: DMC-temp & RH & rain 
figure 18-20: DMC-temp / RH / rain
p.s.: for the plots related to rain, for better observation, manual adjustment is needed since scatters were initially distributed around 0.00
'''
plt.figure(17)
sub=131
...
4th demension
q:DMC 
displaying DMC by using different colors of histograms 
'''
