# -*- coding: utf-8 -*-
"""
Created on Sun Dec  2 14:51:50 2018
...
plt.figure(1)
df1=pd.DataFrame(fire,columns=['FFMC','temp','rain','RH','wind','ln(area+1)'])
...
for i in ['temp','rain']:
  ...
  pal='Reds'
  sns.kdeplot(df1[i],df1['FFMC'], # demonstrate the probability distribution of two variables
